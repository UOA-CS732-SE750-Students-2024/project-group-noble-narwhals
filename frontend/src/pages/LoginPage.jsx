...
function LoginPage({ ifLogin = true }) {
  ...
  return (
    <>
      <div
        id="login_background"
        className="h-screen w-screen bg-gradient-to-b from-blue-400 to-emerald-300 hidden sm:flex flex-row  justify-between relative"
      >
        ...
        >
          ...
          <img
            src={`${
              isLogin ? "/image/login_pic.png" : "/image/signup_pic.png"
            }`}
            alt="cover"
      ...
      <div
        id="login_background"
        className="h-screen w-screen bg-gradient-to-b from-blue-400 to-emerald-300 flex sm:hidden flex-row  justify-between relative"
      >
        {isLogin ? (
          <LogAndSign loginType={isLogin} switchHandler={switchLoginAndSign} />
        ) : (
          <LogAndSign loginType={false} switchHandler={switchLoginAndSign} />
        )}
      </div>
