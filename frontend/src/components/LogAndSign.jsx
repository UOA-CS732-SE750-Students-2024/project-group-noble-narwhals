    ...
    <div className="flex flex-col items-center justify-around p-11 w-full">
      <div className="flex flex-col items-center justify-around gap-6">
        ...
        <form
          ...
          className="flex flex-col items-center gap-9 w-64"
        >
          <div className="w-full flex flex-row items-center justify-between h-12 p-1 pl-4 rounded-full bg-white focus-within:outline outline-2 outline-primary">
            <input
              type="text"
