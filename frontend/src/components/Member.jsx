...
function Member({ username, role, avatar }) {
  ...
  return (
    <div className="flex flex-col items-center w-60 h-96 bg-gradient-to-r from-blue-100 to-blue-300 rounded-lg space-y-4 m-5">
      ...
      {role !== 'Host' && (
        <div className="w-full pb-4 px-4 flex justify-between">
          <Button className="  w-20 py-1" style_type="fill">
            View
          </Button>
          <Button className="  w-20 py-1" style_type="border">
            Delete
          </Button>
        </div>
      )}
